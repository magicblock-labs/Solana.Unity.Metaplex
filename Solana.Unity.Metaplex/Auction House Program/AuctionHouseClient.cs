...
namespace Solana.Unity.Metaplex.Auctionhouse
{
    ...
    public partial class AuctionHouseClient : TransactionalBaseClient<AuctionHouseErrorKind>
    {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribeBidReceiptAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, BidReceipt> callback, Commitment commitment = Commitment.Finalized)
        {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribeListingReceiptAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, ListingReceipt> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribePurchaseReceiptAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, PurchaseReceipt> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribeAuctionHouseAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, AuctionHouse> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribeAuctioneerAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, AuctioneerUser> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
