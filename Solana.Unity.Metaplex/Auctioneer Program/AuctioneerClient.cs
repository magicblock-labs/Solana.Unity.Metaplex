...
using Solana.Unity.Metaplex.Auctioneer.Accounts;
using Solana.Unity.Metaplex.Auctioneer.Errors;
...
namespace Solana.Unity.Metaplex.Auctioneer
{
    ...
    public partial class AuctioneerClient : TransactionalBaseClient<AuctioneerErrorKind>
    {
        ...
        public async Task<SubscriptionState> SubscribeAuctioneerAuthorityAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, AuctioneerAuthority> callback, Commitment commitment = Commitment.Finalized)
        {
        ...
        public async Task<SubscriptionState> SubscribeListingConfigAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, ListingConfig> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
