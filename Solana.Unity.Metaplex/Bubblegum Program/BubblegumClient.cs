using Solana.Unity.Metaplex.Bubblegum.Accounts;
using Solana.Unity.Metaplex.Bubblegum.Errors;
...
namespace Solana.Unity.Metaplex.Bubblegum
{
    ...
    public partial class BubblegumClient : TransactionalBaseClient<BubblegumErrorKind>
    {
        ...
        public async Task<SubscriptionState> SubscribeTreeConfigAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, TreeConfig> callback, Commitment commitment = Commitment.Finalized)
        {
        ...
        public async Task<SubscriptionState> SubscribeVoucherAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, Voucher> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
