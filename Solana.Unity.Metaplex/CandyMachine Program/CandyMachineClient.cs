...
namespace Solana.Unity.Metaplex.Candymachine
{
    ...
    public partial class CandyMachineClient : TransactionalBaseClient<CandyMachineErrorKind>
    {
        ...
        public async Task<SubscriptionState> SubscribeCandyMachineAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, CandyMachine> callback, Commitment commitment = Commitment.Finalized)
        {
        ...
        public async Task<SubscriptionState> SubscribeCollectionPDAAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, CollectionPDA> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
        ...
        public async Task<SubscriptionState> SubscribeFreezePDAAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, FreezePDA> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
