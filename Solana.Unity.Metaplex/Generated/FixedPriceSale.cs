...
using Solana.Unity.Metaplex.FixedPriceSale.Accounts;
using Solana.Unity.Metaplex.FixedPriceSale.Errors;
using Solana.Unity.Metaplex.FixedPriceSale.Program;
using Solana.Unity.Metaplex.FixedPriceSale.Types;

// ReSharper disable once CheckNamespace

namespace Solana.Unity.Metaplex.FixedPriceSale
{
    namespace Accounts
    {
        ...
        public partial class PrimaryMetadataCreators
        {
            ...
            public Types.Creator[] Creators { get; set; }
            ...
            public static PrimaryMetadataCreators Deserialize(ReadOnlySpan<byte> _data)
            {
                ...
                offset += 4;
                result.Creators = new Types.Creator[resultCreatorsLength];
                for (uint resultCreatorsIdx = 0; resultCreatorsIdx < resultCreatorsLength; resultCreatorsIdx++)
                {
                    offset += Types.Creator.Deserialize(_data, offset, out var resultCreatorsresultCreatorsIdx);
    ...
    public partial class FixedPriceSaleClient : TransactionalBaseClient<FixedPriceSaleErrorKind>
    {
        ...
        public async Task<RequestResult<string>> SendSavePrimaryMetadataCreatorsAsync(SavePrimaryMetadataCreatorsAccounts accounts, byte primaryMetadataCreatorsBump, Types.Creator[] creators, PublicKey feePayer, Func<byte[], PublicKey, byte[]> signingCallback, PublicKey programId)
        {
    ...
    namespace Program
    {
        ...
        public static class FixedPriceSaleProgram
        {
            ...
            public static Solana.Unity.Rpc.Models.TransactionInstruction SavePrimaryMetadataCreators(SavePrimaryMetadataCreatorsAccounts accounts, byte primaryMetadataCreatorsBump, Types.Creator[] creators, PublicKey programId)
            {
                List<Solana.Unity.Rpc.Models.AccountMeta> keys = new()
