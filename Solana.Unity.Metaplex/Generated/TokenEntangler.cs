...
using Solana.Unity;
using Solana.Unity.Metaplex.TokenEntangler.Accounts;
using Solana.Unity.Metaplex.TokenEntangler.Errors;
using Solana.Unity.Metaplex.TokenEntangler.Program;
...
using Solana.Unity.Metaplex.TokenEntangler;

// ReSharper disable once CheckNamespace

namespace Solana.Unity.Metaplex.TokenEntangler
{
    namespace Accounts
    {
