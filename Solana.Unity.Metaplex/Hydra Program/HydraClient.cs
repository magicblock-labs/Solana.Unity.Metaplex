using Solana.Unity.Metaplex.Hydra.Accounts;
using Solana.Unity.Metaplex.Hydra.Types;
...
namespace Solana.Unity.Metaplex.Hydra
{
    /// <summary>
    ...
    public partial class HydraClient : TransactionalBaseClient<HydraErrorKind>
    {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribeFanoutAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, Fanout> callback, Commitment commitment = Commitment.Finalized)
        {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribeFanoutMintAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, FanoutMint> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribeFanoutMembershipVoucherAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, FanoutMembershipVoucher> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
        ...
        /// <param name="commitment"></param>
        /// <returns></returns>
        public async Task<SubscriptionState> SubscribeFanoutMembershipMintVoucherAsync(string accountAddress, Action<SubscriptionState, Solana.Unity.Rpc.Messages.ResponseValue<AccountInfo>, FanoutMembershipMintVoucher> callback, Commitment commitment = Commitment.Finalized)
        {
            SubscriptionState res = await StreamingRpcClient.SubscribeAccountInfoAsync(accountAddress, (s, e) =>
            {
